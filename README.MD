...
* Double-clicking `ssc_to_sm.py` (or running it without arguments) opens a
  console that prompts you to paste the folder containing your `.ssc` files. It
  will include all subfolders automatically.
